import QuizFeedbackComp from '@/components/ui/QuizFeedbackComp'
...
const QuizFeedback: React.FC<ChapterIntroProps> = ({ onComplete, onBack }) => {
  ...
  return (
    <QuizFeedbackComp
      ...
      message={"You speak truth. The Ledger is eternal because no link can be broken. This is the foundation of all blockchains."}
